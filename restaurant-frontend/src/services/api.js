...
export const ordersAPI = useMockData ? {
  getAll: () => mockApi.getOrders(),  // This is correct
...
// Reports API
// Add these methods to the reportsAPI object
export const reportsAPI = useMockData ? {
  ...
  getCustomerAnalytics: (params) => axiosInstance.get('/reports/customers', { params }),
  getPeakHours: (params) => axiosInstance.get('/reports/peak-hours', { params }),
  getRecentOrders: () => axiosInstance.get('/reports/recent-orders'),
  getPopularMeals: () => axiosInstance.get('/reports/popular-meals'),
  getSalesAnalytics: (params) => axiosInstance.get('/reports/sales-analytics', { params }),
};
// Add this to the existing API configuration
